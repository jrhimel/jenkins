...
dt=https://github.com/jrhimel/RRD.git
dt_branch=xq		#Dt branch to use for build
...
vt=https://github.com/jrhimel/RRV.git
vt_branch=10		#Vendor branch to use for build
